...
- `npm run dev` - Inicia a API em modo desenvolvimento (porta 3001)
...
**Documentação completa da API:** Veja `server/README.md`
...
2. Verifique as credenciais no arquivo `server/.env`
...
- **API Backend**: `server/README.md` - Documentação completa da API
